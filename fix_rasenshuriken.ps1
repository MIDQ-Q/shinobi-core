...
$f = "E:\Games\mod\src\main\java\com\example\shinobicore\jutsu\custom\RasenshurikenBehavior.java"
...
Write-Host "[OK] RasenshurikenBehavior: fixed lambda capture with AtomicReference"