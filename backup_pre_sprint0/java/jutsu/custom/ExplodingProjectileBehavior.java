...
public class ExplodingProjectileBehavior implements JutsuBehavior {
    ...
    public void cast(ServerPlayerEntity player, JutsuDefinition def, NinjaPlayerData data,
        ...
        float explosionRadius = radius * 0.5f; // Explosion radius is half of projectile visual radius
        
        Vec3d eye = player.getEyePos();
        Vec3d look = player.getRotationVector();
        
        // Create exploding fireball projectile with proper model and explosion on hit
        VoxelProjectileEntity proj = new VoxelProjectileEntity(
            world, player, look.multiply(speed), "fireball", 0xFFFF6600, radius * 0.5f, damage, false, true, explosionRadius
        );
