...
public class ParkourComponentImpl implements IParkourComponent {
    private int jumpsLeft = ShinobiConstants.JUMPS_PER_RESET;
    ...
    @Override public void resetJumps() { this.jumpsLeft = ShinobiConstants.JUMPS_PER_RESET; }
    ...
    @Override public void readFromNbt(NbtCompound nbt) {
        ...
        try { this.currentPose = NinjaPose.valueOf(poseName); } catch (IllegalArgumentException e) { this.currentPose = NinjaPose.NORMAL; }
    }
