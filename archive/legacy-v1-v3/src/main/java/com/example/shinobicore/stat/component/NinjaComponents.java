...
/**
 * Registry of all CCA components.
 * Each component is registered with a unique identifier.
 */
public final class NinjaComponents {
    ...
    public static boolean hasAllComponents(PlayerEntity p) {
        return getChakra(p) != null && getStats(p) != null && getClan(p) != null
            && getJutsu(p) != null && getDojutsu(p) != null && getParkour(p) != null
            && getCombat(p) != null;
    }
}