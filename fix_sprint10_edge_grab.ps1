...
Write-Host " FIX SPRINT 10: BlockPos constructor" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
# Replace "new BlockPos(checkPos)" with "new BlockPos(checkPos.x, checkPos.y, checkPos.z)"
$oldPattern = "new BlockPos(checkPos)"
$newPattern = "new BlockPos(checkPos.x, checkPos.y, checkPos.z)"

if ($content.Contains($oldPattern)) {
    $content = $content.Replace($oldPattern, $newPattern)
    Write-Ok "Replaced BlockPos constructor call"
} else {
...
Write-Host " FIX SPRINT 10 COMPLETE" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
Write-Host ""
