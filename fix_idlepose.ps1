...
# Переписываем IdlePoseSystem.java целиком
# Вместо ModItems.SHURIKEN используем instanceof ThrowingWeaponItem
$code = @'
...
Write-Host "[OK] IdlePoseSystem.java rewritten (uses instanceof ThrowingWeaponItem)" -ForegroundColor Green
