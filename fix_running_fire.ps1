...
$f = "E:\Games\mod\src\main\java\com\example\shinobicore\jutsu\custom\RunningFireBehavior.java"
...
Write-Host "[OK] RunningFireBehavior: fixed lambda capture with final step variable"