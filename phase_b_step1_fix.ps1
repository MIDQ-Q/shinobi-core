...
$target = "E:\Games\mod\src\main\java\com\example\shinobicore\jutsu\GenjutsuBehavior.java"
...
[System.IO.File]::WriteAllText($target, $code, $utf8)
Write-Host "[FIX] GenjutsuBehavior.java overwritten (removed raycastEntity)"